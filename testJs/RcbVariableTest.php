...
<head>
	...
	<title>Unit Testing RCBs Variable</title>
	<link rel="stylesheet"
...
<body>
  ...
  <div class="row">
                  ...
                  <table class="table table-bordered table-hover dataTable no-footer" id="iec-variable-table" name="iec-variable-table" role="grid" aria-describedby="iec-variable-table_info" style="width: 1531px;">
                    ...
                    <tbody>
                      <tr role="row" class="odd">
                        ...
                        <td>
                          <input type="checkbox" name="rcb_checkbox[]" class="rcb_checkbox" value=" 3. 2. 31">
                        </td>
                      </tr>
                      <tr role="row" class="even">
                        ...
                        <td>
                          <input type="checkbox" name="rcb_checkbox[]" class="rcb_checkbox" value=" 3. 2. 32">
                        </td>
                      </tr>
                      <tr role="row" class="odd">
                        <td class="sorting_1">2</td>
                        ...
                        <td>
                          <input type="checkbox" name="rcb_checkbox[]" class="rcb_checkbox" value=" 3. 2. 33">
                        </td>
                      </tr>
                      <tr role="row" class="even">
                        <td class="sorting_1">2</td>
                        ...
                        <td>
                          <input type="checkbox" name="rcb_checkbox[]" class="rcb_checkbox" value=" 3. 2. 34">
                        </td>
                      </tr>
                      <tr role="row" class="odd">
                        <td class="sorting_1">2</td>
                        ...
                        <td>
                          <input type="checkbox" name="rcb_checkbox[]" class="rcb_checkbox" value=" 3. 2. 35">
                        </td>
                      </tr>
                    </tbody>
                  </table>
	...
	<script>
      ...
      $('.rcb_checkbox').change(function() {
        const total = $('.rcb_checkbox').length
        const number = $('.rcb_checkbox:checked').length

        if (total === number) {
          $('.selectRcbAll').prop('checked', true)
        } else {
          $('.selectRcbAll').prop('checked', false)
        }
      })
