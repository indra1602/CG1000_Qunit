...
<head>
	...
	<title>Unit Testing RCB TMP Variable</title>
	<link rel="stylesheet"
...
<body>
  ...
  <div class="modal-content">
                ...
                <table class="table table-bordered table-hover dataTable no-footer" width="100%" id="iec-tmp-variable-table" name="iec-tmp-variable-table" role="grid" aria-describedby="iec-tmp-variable-table_info" style="width: 100%;">
                  ...
                  <tbody>
                    <tr role="row" class="odd">
                      ...
                      <td>0</td>
                      <td>
                        <input type="checkbox" data-id=" 3. 2. 31" name="tmp_rcb[]" class="tmp_rcb">
                      </td>
                    </tr>
                    <tr role="row" class="even">
                      ...
                      <td>0</td>
                      <td>
                        <input type="checkbox" data-id=" 3. 2. 32" name="tmp_rcb[]" class="tmp_rcb">
                      </td>
                    </tr>
                    <tr role="row" class="odd">
                      <td class="sorting_1">2</td>
                      ...
                      <td>0</td>
                      <td>
                        <input type="checkbox" data-id=" 3. 2. 33" name="tmp_rcb[]" class="tmp_rcb">
                      </td>
                    </tr>
                    <tr role="row" class="even">
                      <td class="sorting_1">2</td>
                      ...
                      <td>0</td>
                      <td>
                        <input type="checkbox" data-id=" 3. 2. 34" name="tmp_rcb[]" class="tmp_rcb">
                      </td>
                    </tr>
                    <tr role="row" class="odd">
                      <td class="sorting_1">2</td>
                      ...
                      <td>0</td>
                      <td>
                        <input type="checkbox" data-id=" 3. 2. 35" name="tmp_rcb[]" class="tmp_rcb">
                      </td>
                    </tr>
                    <tr role="row" class="even">
                      <td class="sorting_1">2</td>
                      ...
                      <td>0</td>
                      <td>
                        <input type="checkbox" data-id=" 3. 2. 36" name="tmp_rcb[]" class="tmp_rcb">
                      </td>
                    </tr>
                    <tr role="row" class="odd">
                      <td class="sorting_1">2</td>
                      ...
                      <td>0</td>
                      <td>
                        <input type="checkbox" data-id=" 3. 2. 37" name="tmp_rcb[]" class="tmp_rcb">
                      </td>
                    </tr>
                    <tr role="row" class="even">
                      <td class="sorting_1">2</td>
                      ...
                      <td>0</td>
                      <td>
                        <input type="checkbox" data-id=" 3. 2. 38" name="tmp_rcb[]" class="tmp_rcb">
                      </td>
                    </tr>
                    <tr role="row" class="odd">
                      <td class="sorting_1">2</td>
                      ...
                      <td>0</td>
                      <td>
                        <input type="checkbox" data-id=" 3. 2. 39" name="tmp_rcb[]" class="tmp_rcb">
                      </td>
                    </tr>
                    <tr role="row" class="even">
                      <td class="sorting_1">2</td>
                      ...
                      <td>0</td>
                      <td>
                        <input type="checkbox" data-id=" 3. 2. 40" name="tmp_rcb[]" class="tmp_rcb">
                      </td>
                    </tr>
                  </tbody>
                </table>
	...
	<script>
      ...
      $('.tmp_rcb').change(function() {
        const total = $('.tmp_rcb').length
        const number = $('.tmp_rcb:checked').length

        if (total === number) {
          $('.selectTmpRcbAll').prop('checked', true)
          console.log(1)
        } else {
          $('.selectTmpRcbAll').prop('checked', false)
          console.log(0)
        }
      })
