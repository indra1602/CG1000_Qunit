            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">IEC Variables</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Variable List</li>
                                    <li class="breadcrumb-item"><a href="/variable-list/iec-variable" class="text-muted">Slave Variables</a></li>
                                    <li class="breadcrumb-item"><a href="/variable-list/iec-variable" class="text-muted">IEC Variables</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="customize-input float-right">
                            <div class="dropdown show">
                                ...
                                <div class="dropdown-menu" aria-labelledby="downloadMenu">
                                    <a class="dropdown-item" value="0" name="btnCSV" href="{{ url('/variable-list/iec-variable/download/csv') }}">CSV</a>
                                    <a class="dropdown-item" value="1" name="btnXLSX" href="{{ url('/variable-list/iec-variable/download/xlsx') }}">XLSX</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body border-top">
                                ...
                                @endif
                                <form class="form-horizontal" method="POST" action="{{ url('/variable-list/iec-variable/import') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body border-top">
                                <center><h3>IEC VARIABLE DATA</h3></center>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="iec-variable-table" name="iec-variable-table" style="color:#000000">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item deleteIecVariable" href="javascript:void(0)" data-toggle="tooltip" data-id-variable="{{$row->ID_VARIABLE}}" data-original-title="Delete">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <input type="checkbox" name="iec_checkbox[] " class="iec_checkbox" value="{{$row->ID_VARIABLE}}"/>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    ...
                                    <div class="btn-group float-right">
                                        ...
                                        <div class="dropdown-menu">
                                            <a id="iec_bulk_delete"class="dropdown-item iec_bulk_delete"  href="javascript:void(0)">Delete Selected</a>
                                            <a class="dropdown-item deleteAllIecVariable" href="javascript:void(0)">Delete All</a>
                                        </div>
                                    </div>
